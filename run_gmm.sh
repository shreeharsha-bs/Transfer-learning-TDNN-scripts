...
audio_dir=/home/shreeharsha/Desktop/iitm_challenge/   #complete path to the folder with all wav audio files; should be organised in train, dev, eval subfolders
...
echo ============================================================================           
	...
	utils/prepare_lang.sh $data/local/dictionary2 \
